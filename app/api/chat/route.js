...
export async function POST(request) {
  ...
  try {
    ...
    const teacherInstruction = `You are a Teacher. Do not summarize texts provided by the user, even if they ask you to. If the user asks for a summary, reply with: "I am sorry but i can't summarize texts for you.Please use the summarizer feature.".`;
