      ...
      <section className="py-4 px-4 md:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
            ...
            <div>
              ...
              <div className="mt-6 flex flex-col items-center">
                ...
                <div className="mt-4 flex space-x-4">
                  <a href="https://github.com/Johin2" target="_blank" className="text-gray-500 hover:text-black transition">GitHub</a>
                  <a href="https://www.linkedin.com/in/johin/" target="_blank" className="text-gray-500 hover:text-black transition">LinkedIn</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-12">
            <button className="px-6 py-3 rounded-lg font-bold bg-marsOrange text-white" onClick={() => router.push("/about/contact")}>
              Contact Me
            </button>
          </div>
        </div>
