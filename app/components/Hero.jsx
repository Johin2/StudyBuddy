  ...
  return isUser ? (
        ...
        <div className="grid grid-cols-4 grid-rows-2 gap-10 h-full w-full p-12">
          <div className="col-span-2 row-span-3 flex flex-col justify-center gap-6">
            <h1 className="text-4xl font-bold text-gray-400">
              Study Smarter with{' '}
              <span className="text-midBlue">StudyBuddy</span>
            </h1>
          ...
          <div
            className="flex flex-col space-y-3 cursor-pointer justify-center items-center rounded-md border hover:bg-gray-700"
    ...
    <div className="flex h-screen w-screen">
      <div className="w-[50%] h-full overflow-hidden rounded-md">
        <h1 className="text-2xl fixed top-0 left-0 pl-4 pt-4 font-bold text-white">
          StudyBuddy
        </h1>
        <img
      ...
      <div className="w-[50%] h-full flex justify-center items-center flex-col">
        <form
          ...
          className="flex flex-col space-y-6 justify-center items-center w-[80%]"
        >
          ...
          >
            {loading ? <FiLoader className="animate-spin text-xl" /> : isSignup ? 'Sign Up' : 'Log In'}
          </button>
        </form>
      </div>
    </div>
